    ...
    public function testFindNames()
    {
        ...
        $this->assertEquals(
            array(
                ...
                new PhpNameOccurance(new PhpName('QafooLabs\Refactoring\Adapters\PHPParser\ParserPhpNameScanner', 'QafooLabs\Refactoring\Adapters\PHPParser\ParserPhpNameScanner', PhpName::TYPE_USE), $file, 5),
                new PhpNameOccurance(new PhpName('QafooLabs\Refactoring\Domain\Model\File', 'QafooLabs\Refactoring\Domain\Model\File', PhpName::TYPE_USE), $file, 6),
                new PhpNameOccurance(new PhpName('QafooLabs\Refactoring\Domain\Model\PhpName', 'QafooLabs\Refactoring\Domain\Model\PhpName', PhpName::TYPE_USE), $file, 7),
                new PhpNameOccurance(new PhpName('QafooLabs\Refactoring\Domain\Model\PhpNameOccurance', 'QafooLabs\Refactoring\Domain\Model\PhpNameOccurance', PhpName::TYPE_USE), $file, 8),
                new PhpNameOccurance(new PhpName('PHPUnit\Framework\TestCase', 'PHPUnit\Framework\TestCase', PhpName::TYPE_USE), $file, 9),
