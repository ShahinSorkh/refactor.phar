    ...
    public function testFindNames()
    {
        ...
        $this->assertEquals(
            array(
                ...
                new PhpNameOccurance(new PhpName('PHPUnit\Framework\TestCase', 'PHPUnit\Framework\TestCase', PhpName::TYPE_USE), $file, 8),
                new PhpNameOccurance(new PhpName('QafooLabs\Refactoring\Adapters\PHPParser\ParserPhpNameScannerTest', 'ParserPhpNameScannerTest', PhpName::TYPE_CLASS), $file, 10),
                new PhpNameOccurance(new PhpName('PHPUnit\Framework\TestCase', 'TestCase', PhpName::TYPE_USAGE), $file, 10),
                new PhpNameOccurance(new PhpName('QafooLabs\Refactoring\Domain\Model\File', 'File', PhpName::TYPE_USAGE), $file, 14),
                new PhpNameOccurance(new PhpName('QafooLabs\Refactoring\Adapters\PHPParser\ParserPhpNameScanner', 'ParserPhpNameScanner', PhpName::TYPE_USAGE), $file, 15),
            ),
            array_slice($names, 0, 9)
        );
    }
